  ...
  return (
    <div>
      ...
      <div className="hidden lg:flex items-center justify-between border-b border-white/5 bg-neutral-950/30 backdrop-blur px-6 py-3 sticky top-0 z-20">
        ...
        <div className="flex items-center gap-2">
          <a href="https://t.me/signalrelayhub" target="_blank" rel="noreferrer" className="rounded-lg border border-white/10 bg-white/5 px-3 py-1.5 text-xs text-white/40 hover:text-white hover:bg-white/10 transition-colors">
            Telegram ↗
          </a>
          <a href="https://discord.gg/4X9NGZuK" target="_blank" rel="noreferrer" className="rounded-lg border border-white/10 bg-white/5 px-3 py-1.5 text-xs text-white/40 hover:text-white hover:bg-white/10 transition-colors">
            Discord ↗
          </a>
        </div>
      </div>
